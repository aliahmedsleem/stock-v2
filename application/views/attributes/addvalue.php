...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url('attributes/') ?>">الموزعين</a></li>
      <li class="active">كمية الموزعين</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-body">
            <h4>اسم الموزع <?php echo $attribute_data['name']; ?></h4>
          </div>
        </div>
        ...
        <?php //if(in_array('createGroup', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">اضافة كمية</button>
          <br /> <br />
        <?php //endif; ?>
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">ادارة الكميات لدى الموزعين</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">اضافة كمية للموزع</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/createValue') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="brand_name">كمية الموزع</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">تعديل كمية الموزع</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/updateValue') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">كمية الموزع</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">حذف كمية الموزع</h4>
      </div>
