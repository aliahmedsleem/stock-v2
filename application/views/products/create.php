        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="sku">الاسم المختصر</label>
                ...
                <div class="form-group">
                  <label for="brands">المنتجات</label>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('products/') ?>" class="btn btn-warning">الرجوع</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
