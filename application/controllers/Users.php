...
class Users extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'المستخدمين';
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
		        	...
		        	if($update == true) {
		        		$this->session->set_flashdata('نجاح', 'تم الاضافة بنجاح');
		        		redirect('users/', 'refresh');
		        	}
		        	else {
		        		$this->session->set_flashdata('خطا', 'حدث خطا ما');
	...
	public function delete($id)
	{
		...
		if($id) {
			if($this->input->post('confirm')) {
					...
					if($delete == true) {
		        		$this->session->set_flashdata('نجاح', 'تم الحذف بنجاح');
		        		redirect('users/', 'refresh');
		        	}
		        	else {
		        		$this->session->set_flashdata('خطا', 'حدث خطا ما');
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
		        	...
		        	if($update == true) {
		        		$this->session->set_flashdata('نجاح', 'تم التحديث بنجاح');
